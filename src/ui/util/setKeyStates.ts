...
const initKeyState = function (): KeyStates {
    return {
        right: false,
        left: false,
        up: false,
...
const setKeyState = function (keyStates: KeyStates, event: KeyboardEvent): KeyStates {
    let upKey1 = "KeyW";
    let upKey2 = "ArrowUp";
    let downKey1 = "KeyS";
...
const resetKeyState = function (keyStates: KeyStates, event: KeyboardEvent): KeyStates {
    let upKey1 = "KeyW";
    let upKey2 = "ArrowUp";
    let downKey1 = "KeyS";
    let downKey2 = "ArrowDown";

import type { GameScene, NPCObject } from "../../types";

export default function updateNPCPosition(scene: GameScene, obj: NPCObject): void {
    ...
    const currentPos = [obj.position.x, obj.position.y, obj.position.z];
...
function estimateTime(currentPos: number[], targetPos: number[], maxSpeed: number): number {

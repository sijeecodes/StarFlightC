...
import type { PCShip, KeyStates } from "../../types";

export default function updatePCShipUD(pcShip: PCShip, keyStates: KeyStates, maxHeight: number, diagonal: boolean): boolean {

...
import type { GameScene, PCShip, KeyStates } from "../../types";

export default function updatePCShipRoll(scene: GameScene, pcShip: PCShip, keyStates: KeyStates, maxWidth: number): void {
